...
- 💻 This talk on github: https://github.com/fullstackzach/git-talk - (built with [mdx-deck](https://github.com/jxnblk/mdx-deck))
...
A Git GUI is super handy to visualize git history. My favorite is [Fork](https://git-fork.com/)
...
[^1] You may need to [create and use a personal access token](https://help.github.com/en/github/authenticating-to-github/creating-a-personal-access-token-for-the-command-line) for the first time
